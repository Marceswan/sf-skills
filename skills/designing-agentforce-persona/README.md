...
This skill is adapted from [cascadi/designing-agentforce-persona](https://github.com/cascadi/designing-agentforce-persona). See `CREDITS.md` for attribution.
