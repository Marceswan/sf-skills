---
name: designing-agentforce-persona
description: "Deep persona design for Agentforce agents with 50-point scoring. TRIGGER when: user designs agent personas, defines agent personality/identity, creates persona documents, encodes persona into Agent Builder fields or Agent Script, translates brand guidelines to agent voice, or asks about agent tone/voice/register. DO NOT TRIGGER when: building agent metadata (use developing-agentforce), testing agents (use testing-agentforce), or Agent Script DSL (use building-agentscript)."
license: MIT
...
Use `designing-agentforce-persona` when the work involves:
...
- building agent metadata / topics / actions → [developing-agentforce](../developing-agentforce/SKILL.md)
- testing the finished agent → [testing-agentforce](../testing-agentforce/SKILL.md)
- editing `.agent` DSL behavior → [building-agentscript](../building-agentscript/SKILL.md)
...
|---|---|---|
| build topics / actions / metadata | [developing-agentforce](../developing-agentforce/SKILL.md) | implementation after persona design |
| encode behavior into `.agent` logic | [building-agentscript](../building-agentscript/SKILL.md) | deterministic script authoring |
| validate finished agent behavior | [testing-agentforce](../testing-agentforce/SKILL.md) | post-build testing |
