...
5. **Generate fix** by invoking generating-apex skill
...
6. Skill(generating-apex): Add null safety to AccountService.processAccounts()
7. Deploy fix
...
```
Skill(skill="generating-apex", args="Fix failing test [TestClassName].[methodName] - Error: [error message]")
```
