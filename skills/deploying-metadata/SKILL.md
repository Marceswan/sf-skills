...
| File | When to read |
|------|-------------|
| `references/orchestration.md` | Start here -- full deploy/post-deploy orchestration workflows |
| `references/deployment-workflows.md` | Deep reference for deploy, validate, quick-deploy, and CI/CD patterns |
| `references/deployment-report-template.md` | Output template for summarizing a deployment result |
| `references/trigger-deployment-safety.md` | Safe sequencing for trigger / Flow / validation deploys |
| `references/agent-deployment-guide.md` | Agentforce DevOps: `Agent:` pseudo metadata, publish/activate, sync between orgs |
| `references/deploy.sh` | Reference shell script wrapping the deploy workflow |
