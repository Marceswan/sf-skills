<!-- Parent: developing-agentforce/SKILL.md -->
...
>
> **Full ISV workflow**: See [../../deploying-metadata/references/agent-deployment-guide.md](../../deploying-metadata/references/agent-deployment-guide.md) for the complete packaging workflow.
...
|-------------|-------|-------|
| Agent Script `.agent` files, preview, authoring-bundle | [building-agentscript](../../building-agentscript/SKILL.md) | Code-first agent development |
| Deployment orchestration, CI/CD | [deploying-metadata](../../deploying-metadata/SKILL.md) | Agent deployment workflows |
| Test execution, coverage analysis | [testing-agentforce](../../testing-agentforce/SKILL.md) | `sf agent test run/list/results` |
