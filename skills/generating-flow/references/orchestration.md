...
│                                                                             │
│  2. configuring-connected-apps (if external API)                                     │
...
| "Flow not found" | Flow not deployed | deploying-metadata before developing-agentforce |
...
| From Skill | To generating-flow | When |
|------------|------------|------|
| developing-agentforce | → generating-flow | "Create Autolaunched Flow for agent action" |
...
| developing-agentforce | `developing-agentforce/SKILL.md` |
