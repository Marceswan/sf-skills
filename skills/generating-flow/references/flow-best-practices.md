...
|-----------------|----------------------|
| Custom Objects/Fields | Do they exist? Create with generating-custom-object first |
...
> **Validator Note**: The generating-flow validator automatically flags `HardcodedId` and `HardcodedUrl` patterns during analysis.
...
- [ ] **Always use deploying-metadata skill** - never direct CLI commands
