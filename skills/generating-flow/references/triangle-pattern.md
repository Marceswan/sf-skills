...
| Screen Flow with LWC | `generating-flow/assets/screen-flow-with-lwc.xml` |
| LWC integration guide | `generating-flow/references/lwc-integration-guide.md` |
| Apex triangle perspective | `generating-apex/references/triangle-pattern.md` |
| LWC triangle perspective | `generating-lwc-components/references/triangle-pattern.md` |
