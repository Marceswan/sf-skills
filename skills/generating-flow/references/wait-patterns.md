...
- `generating-flow/assets/wait-template.xml` - All three wait patterns with examples
- `generating-flow/assets/platform-event-flow-template.xml` - Event-driven alternative
- `generating-flow/assets/scheduled-flow-template.xml` - Scheduled batch processing
