...
| Topic | Location |
|-------|----------|
| @InvocableMethod templates | `generating-apex/assets/invocable-method.cls` |
| Flow integration guide | `generating-apex/references/flow-integration.md` |
| LWC triangle perspective | `generating-lwc-components/references/triangle-pattern.md` |
| Flow triangle perspective | `generating-flow/references/triangle-pattern.md` |
