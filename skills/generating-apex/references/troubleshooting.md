...
The generating-apex skill includes Language Server Protocol (LSP) integration for real-time syntax validation. This enables Claude to automatically detect and fix Apex syntax errors during code authoring.
...
**If missing, create via generating-custom-object skill.**
