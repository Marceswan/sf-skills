...
npx skills add Jaganpro/sf-skills --skill generating-apex
```
...
|---------------|-------------|
| generating-flow | Create Flow to call @InvocableMethod |
| generating-lwc-components | Create LWC to call @AuraEnabled controllers |
| running-apex-tests | Run tests and analyze coverage |
| deploying-metadata | Deploy Apex to org |
