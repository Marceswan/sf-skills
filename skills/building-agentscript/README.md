...
- ✅ **Cross-skill integration** - Works with generating-flow, testing-agentforce, deploying-metadata
...
npx skills add Jaganpro/sf-skills --skill building-agentscript
```
...
```
/generating-flow → /building-agentscript → /testing-agentforce → /deploying-metadata
   ↑              ↑                      ↑                      ↑
