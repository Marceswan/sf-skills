# Validation History: building-agentscript

This file tracks the validation history of the building-agentscript skill. Validation agents are deployed to a test org to verify that documented patterns still work with current Salesforce releases.
...
cd building-agentscript/validation
