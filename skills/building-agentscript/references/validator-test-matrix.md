...
spec=spec_from_file_location('v','skills/building-agentscript/hooks/scripts/agentscript-syntax-validator.py')
mod=module_from_spec(spec)
spec.loader.exec_module(mod)
for path in sorted(Path('skills/building-agentscript/assets').rglob('*.agent')):
