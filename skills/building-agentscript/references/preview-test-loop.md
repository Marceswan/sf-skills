...
| **Fix loop** | Self-contained in building-agentscript | Cross-skill delegation to testing-agentforce |
| **Skill** | building-agentscript (internal) | testing-agentforce (Phase A/B/C) |
