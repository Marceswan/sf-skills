...
- Analyzing access / permission policy assignments -> [generating-permission-set](../generating-permission-set/SKILL.md)
...
| Permission review after deployment | [generating-permission-set](../generating-permission-set/SKILL.md) | access governance |
