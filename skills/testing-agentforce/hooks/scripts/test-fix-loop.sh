...
# for Claude Code to process and fix via developing-agentforce skill.
#
# Usage:
...
# Exit Codes:
#   0 - All tests passed
#   1 - Tests failed, fixes needed (Claude Code should invoke developing-agentforce)
...
generate_fix_instructions() {
    ...
    echo ""
    echo "1. Invoke the developing-agentforce skill:"
    echo "   Skill(skill=\"developing-agentforce\", args=\"Fix agent failures...\")"
    echo ""
