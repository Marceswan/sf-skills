...
def suggest_fixes(summary: dict, agent_name: str) -> None:
    ...
    if topic_failures:
        ...
        print(f"   Skill(skill=\"developing-agentforce\", args=\"Fix topic routing for {agent_name}:")
    ...
    if action_failures:
        ...
        print("")
        print("   Claude Code command:")
        print(f"   Skill(skill=\"developing-agentforce\", args=\"Fix action triggers for {agent_name}:")
