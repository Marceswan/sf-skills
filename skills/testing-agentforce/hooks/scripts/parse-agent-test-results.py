...
def categorize_failure(failure: dict) -> dict:
    ...
    analysis = {
        ...
        'target_skill': 'developing-agentforce',
        'auto_fixable': False,
        'fix_location': ''
    }
...
def format_output(results: dict) -> str:
    ...
    if failures:
        ...
        for failure_type, items in categorized.items():
            ...
            for i, (failure, analysis) in enumerate(items, 1):
                ...
                if analysis['auto_fixable']:
                    lines.append(f"      AUTO-FIXABLE: Yes - developing-agentforce skill can attempt fix")
        ...
        lines.append("=" * 65)
        lines.append("")
        lines.append("To automatically fix these failures, invoke developing-agentforce skill:")
        lines.append("")
