...
|-------|-----------------|
| running-apex-tests | Agentic test-fix loop pattern |
| building-agentscript | Agent Script authoring integration (recommended) |
| developing-agentforce | Agentforce platform setup |
| configuring-connected-apps | OAuth setup for live preview |
| debugging-apex-logs | Error analysis patterns |
...
| Agentic Fix Loop | running-apex-tests skill | references/agentic-fix-loops.md |
