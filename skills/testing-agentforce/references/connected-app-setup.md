...
| Skill | Use For |
|-------|---------|
| configuring-connected-apps | Create and manage Connected Apps and ECAs |
| generating-flow | Debug failing Flow actions |
| generating-apex | Debug failing Apex actions |
| debugging-apex-logs | Analyze debug logs |
