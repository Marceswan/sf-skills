<!-- Parent: generating-permission-set/SKILL.md -->
# generating-permission-set Usage Examples

Real-world examples of using generating-permission-set for permission analysis.
