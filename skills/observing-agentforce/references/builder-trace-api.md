<!-- Parent: observing-agentforce/SKILL.md -->
...
> For full workflow details, see **testing-agentforce** Phase F: trace-enriched preview testing.
...
5. Analyze with `jq` or the trace analyzer in `testing-agentforce`
