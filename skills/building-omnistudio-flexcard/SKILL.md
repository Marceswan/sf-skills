...
Minimal `DataSourceConfig` shape for an Integration Procedure data source:
...
Read `assets/omni-ui-card.json` for the complete OmniUiCard record template including the full `DataSourceConfig` JSON structure.
