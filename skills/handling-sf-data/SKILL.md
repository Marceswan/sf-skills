...
See [references/sf-cli-data-commands.md](references/sf-cli-data-commands.md) for the full `sf sobject describe` command set and additional jq filter patterns.
...
- `hooks/scripts/soql_validator.py` - hook-registered copy of the SOQL validator
- `hooks/scripts/validate_data_operation.py` - hook-registered copy of the data-operation pre-flight check
